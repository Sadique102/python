...
print("Assesment = Correct answers (Per question = 1p) + Total point of dice. To unlock the level 2, you have to get at least 7p. To win the game you have to pass the level 2.")
...
if score >= 7:
    ...
    print("Assesment = Correct answers (Per question = 1p), Total point of dice. To pass the quiz, either you have to get from dice 6p or from quiz 6p")
    ...
    print("       LEVEL 2        ")
    print("----------------------")
    print("You can't enter into level 2")
